...
from skills.agent_browser.deploy_config import (
    DeployConfig,
    ConfigIssue,
    validate_config,
    detect_environment,
...
class TestLoadDeployConfig:
    ...
    def test_missing_file_returns_defaults(self, tmp_path):
        ...
        with mock.patch("skills.agent_browser.deploy_config.CONFIG_PATH", tmp_path / "nonexistent.yaml"):
...
class TestGenerateConfig:
    ...
    def test_yaml_roundtrip(self, tmp_path):
        ...
        with mock.patch("skills.agent_browser.deploy_config.CONFIG_PATH", target):
