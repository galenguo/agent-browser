#!/usr/bin/env python3
"""Skill Daemon -- persistent proxy process for agent-browser API service.
...
Communication: Unix domain socket (~/.agent-browser/skill-daemon.sock)
...
Lifecycle:
  ...
  - Writes PID to ~/.agent-browser/skill-daemon.pid
...
_STATE_DIR = Path.home() / ".agent-browser"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Agent Browser Skill Daemon")
