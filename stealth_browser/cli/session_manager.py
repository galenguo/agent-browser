...
Provides:
  ...
  CLISessionManager -- JSON file-based session store (~/.stealth-browser/sessions.json)
...
DEFAULT_STORAGE = Path.home() / ".stealth-browser" / "sessions.json"
...
class CLISessionManager:
    ...
    ``~/.stealth-browser/sessions.json``).  All mutations are atomic: read →
...
class UnifiedSessionManager:
    ...
    async def create_session(
        ...
        from stealth_browser.stealth.browser_controller import BrowserController
