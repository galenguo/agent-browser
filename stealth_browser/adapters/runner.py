...
async def run_adapter(
    ...
    **kwargs: Any,
    ...
    try:
        ...
        if own_session:
            try:
                from stealth_browser.main import delete_session
...
async def _ensure_session_accessible(session_id: str, api_url: str | None = None) -> bool:
    ...
    """
    from stealth_browser.main import _ensure_middleware, reset, configure
...
async def _cleanup_switched_backend():
    ...
    try:
        from stealth_browser.main import _middleware
