"""StealthBrowser -- clean OOP interface to the stealth-browser package.
...
class StealthBrowser:
    """Object-oriented facade for the stealth-browser automation library.
    ...
    def __init__(self, config: SkillConfig | None = None, session_id: str | None = None):
        """Create an StealthBrowser instance.
