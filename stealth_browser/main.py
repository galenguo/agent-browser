"""Stealth Browser main entry point -- lightweight facade (routes all operations through StealthMiddleware)
...
async def open_page(session_id: str, url: str):
    from stealth_browser.pipeline.steps import _validate_url
...
async def debug_pipeline(
    ...
    **kwargs,
    ...
    from stealth_browser.pipeline.debugger import debug_pipeline as _debug
