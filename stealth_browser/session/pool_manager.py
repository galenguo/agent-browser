...
from stealth_browser.browser.instance_pool import BrowserInstancePool
...
class SessionPoolManager:
    ...
    async def _health_check_loop(self):
        ...
        """
        from stealth_browser.models import DockerBrowserInstance, K8sBrowserInstance
    ...
    def _get_backend(self):
        ...
        if self._backend is None:
            from stealth_browser.browser.local import LocalCDPBackend, LocalSession
    ...
    async def _inject_stealth_if_needed(self, session_id: str, page) -> None:
        ...
        try:
            from stealth_browser.stealth.enhancer import StealthEnhancer as _SE
